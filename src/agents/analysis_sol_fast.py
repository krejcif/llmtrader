"""Analysis for Sol Fast Strategy - Custom EMA 7/25"""
import sys
import os
...
def analyze_market_sol_fast(state: TradingState, strategy_name: str,
                                 tf_higher: str, tf_lower: str) -> TradingState:
    """
    Market analysis for Sol Fast strategy with custom EMA 7/25
