"""Analysis for XRP Fast Strategy - Custom EMA 7/25"""
import sys
import os
...
def analyze_market_xrp_fast(state: TradingState, strategy_name: str,
                                 tf_higher: str, tf_lower: str) -> TradingState:
    """
    Market analysis for XRP Fast strategy with custom EMA 7/25
